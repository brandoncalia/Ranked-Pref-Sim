...
In order to simulate a realistic election, we must first understand what a real election looks like. [Preflib](https://www.preflib.org/) hosts full sets of ballots from historical ranked preference elections, which the program will take in and collect data on. Raw files look like the sample below, with a heading and then line-by-line ballots: : <br /> <br />
...
We ran 122 real elections and collected the following data (generated by the code): 

<img width="600" alt="histdata" src="https://user-images.githubusercontent.com/41372799/204260835-98d70f0b-accb-4237-b619-ce31010352e6.PNG">

However, filtering by only larger political elections (> 2500 voters) yields the following:

<img width="600" alt="histdata2" src="https://user-images.githubusercontent.com/41372799/204261343-de7ab613-3b70-4f63-a523-7fe8d1aee909.PNG">

We remain puzzled by the unusually high agreement of Instant Runoff with Condorcet. It is possible that, because a large portion of these elections had results selected via Instant Runoff when they happened, voters somehow tailored their votes strategically to fit with their understanding of the counting method. In simulation, we could not replicate this effect, regardless of parameters.  
...
Here is a sample scatterplot & results of one simulated election (low voter number for visual effect):
...
<img width="300" alt="freq" src="https://user-images.githubusercontent.com/41372799/204259941-ca65b7b1-cf48-4cf8-a420-26f2e9e2344e.PNG">

Spatial positioning of Plurality vs. Condorcet winners, Baldwin vs. Instant Runoff winners when the methods disagree:

<img width="300" alt="plrcond" src="https://user-images.githubusercontent.com/41372799/204259511-ad37be61-ef46-4011-8155-f597b0d40178.png"> <img width="300" alt="bwir" src="https://user-images.githubusercontent.com/41372799/204259718-1288e8f4-d6ab-467d-854f-715ab581e85d.png">
