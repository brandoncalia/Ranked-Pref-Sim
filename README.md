...
The script aims to accomplish just that, based on both political/mathematical literature & data collected from real elections. 
## Early (fruitless) simulation methods
